...
class ConsoleLogMainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.showMaximized()
        self.error_message.connect(self.error_handler)
    ...
    def init_threading(self):
        try:
            ...
            self.error_message.emit(exception)
    ...
    """ GUI HANDLING """
    @QtCore.pyqtSlot(str)
    def error_handler(self, error_details):
        error_msg = QtWidgets.QMessageBox()
        error_msg.setWindowTitle('Error')
        error_msg.setIcon(QtWidgets.QMessageBox.Critical)
        error_msg.setText(error_details)
        error_msg.setStandardButtons(QtWidgets.QMessageBox.Cancel)
        error_msg.buttonClicked.connect(self.clear_all)
        error_msg.exec_()
