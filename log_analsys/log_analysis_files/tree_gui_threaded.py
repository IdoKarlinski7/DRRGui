...
class LogWidgetWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        loadUi('log_analysis_layout.ui', self)
    ...
    def init_dialog(self):
        self.textEdit.clear()
        self.dialog_win = dialog.FileDialog()
    ...
    def link_menu_bar_functions(self):
        self.actionOpen.triggered.connect(self.init_dialog)
    ...
    def on_dialog_click(self):
        ...
        self.parse_log.emit(self.dialog_win.file_name)
